# -*- coding: utf-8 -*-
"""
Created on Sat Feb 25 02:23:02 2023
...
def main():
    ...
    Pedigree = st.text_input("Pedigree")
    ...
    if st.button('Diabetes Test Result'):
        diagnosis = diabetes_prediction([Pregnancies, Glucose, BloodPressure, SkinThickness, Insulin, BMI, Pedigree, Age])
